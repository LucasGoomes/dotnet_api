...
namespace DotnetAPI.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        //GET POST BY POSTID, USERID OR SEARCH PARAMETER PROCEDURE
        [HttpGet("Posts/{postId}/{userId}/{searchParameter}")]
        public IEnumerable<Post> GetPosts(int postId = 0, int userId = 0, string searchParameter = "None")
        {
            ...
            if (searchParameter.ToLower() != "none")
            {
                parameters += ", @SearchValue=@SearchParam";
                sqlParameters.Add("@SearchParam", searchParameter, DbType.String);
            }
        ...
        public IActionResult UpsertPost(Post postToUpsert)
        {
            ...
            throw new Exception("Error to add new post!");
        }
